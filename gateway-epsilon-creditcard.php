...
/**
 * Plugin Name: WooCommerce Payment Gateway Credit Card- GMO Epsilon
 * Plugin URI: http://www.wp-pay.com/
 * Description: Accept major credit cards directly on your WooCommerce site in a seamless and secure checkout environment with GMO Epsilon Commerce.
 * Version: 1.0.0
  ...
  DEFINE ('PLUGIN_DIR', plugins_url( basename( plugin_dir_path( __FILE__ ) ), basename( __FILE__ ) ) . '/' );
	 ...
	 */
        ...
        // Create plugin fields and settings
				...
				$this->init_settings();
				$this->init();
		$this->method_title       = __( 'GMO Epsilon Credit Card Payment Gateway', 'wc-epsilon' );
		$this->method_description = __( 'Allows payments by GMO Epsilon Credit Card in Japan.', 'wc-epsilon' );
	...
	public function load_plugin_textdomain() {
       ...
       */
			function admin_options() { ?>
				<h3><?php _e( 'Epsilon Payment','wc-epsilon' ); ?></h3>
